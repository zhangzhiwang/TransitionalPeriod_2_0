...
## 2026-07-19（解释 Prompt 是什么）

### 会话的主要目的
- 回答用户问题「promt是什么」（拼写应为 prompt）

### 完成的主要任务
1. 说明 Prompt 在 AI/Cursor 语境下的含义：给模型的指令或输入文本
2. 区分用户提示词、系统提示词、常见用法（对话输入、Rules、Agent 任务描述）
3. 按项目规则将本会话总结追加到根目录 `README.md`

### 关键决策和解决方案
- 将 `promt` 按常见笔误理解为 `prompt`，用简洁中文解释概念与日常用法
- 本会话无业务代码改动，仅追加会话总结

### 使用的技术栈
- 概念答疑（无新代码栈）
- Markdown（`README.md` 会话日志）
